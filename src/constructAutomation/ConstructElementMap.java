...
class ConstructElementMap extends SensitiveData {
    /**
     * <h1>BXP</h1> Abstracted shortener method for
     * {@link org.openqa.selenium.By#xpath(String)}
     * 
	...
	static class Effects {
		...
		static By replaceSolidColor = bxp(
	...
	static class Plugins {
		...
		static By speechRecognition = bxp(
	    ...
	    static By dataAndStorageExpander = bxp(
	...
	static class GuidedToursPopout {
	    ...
	    static By getStartedWithTimelineAnimations = bxp(
