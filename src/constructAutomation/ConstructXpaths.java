...
class ConstructXpaths {
	...
	static String clear = "buttonClear";
	static String clearButtonFooter = "resultsFooterClearTags";
	static String effects = "titleSection -effect";
	static String genres = "titleSection -genre";
	static String levels = "titleSection -level";
	static String plugins = "titleSection -plugin";
	static String searchBox = "searchInputField";
	static String tags = "titleSection -tag";
	...
	static String logInLink = "log in to your account";
	...
	static class AccountPopout {
	    ...
	    static String purchase = "//span[text()='Purchase...']/..";
	    /*
	     * Locators are the same as account Dropdown, however these two can't exist in
	     * the DOM together at the same time.
	     */
	    static String register = "//span[text()='Register...']/..";
	    static String viewDetails = "//span[text()='View details']/..";
	}
	...
	static class CreateNewObjectTypePopup {
	    static String name = "crObjectTypeNameInput";
